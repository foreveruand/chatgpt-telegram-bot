...
| `OPENAI_PROVIDER`        | API provider(azure,openai,deepseek)                                                                  |
...
| `DEEPSEEK_API_KEY`                  | API token of deepseek( required if use deepseek)                                                                                                                                                                                                                                        | -                                  |
| `DEEPSEEK_MODEL`                  | The Deepseek model to use for generating responses.                                                                                                                                                                                                                                        | `deepseek-chat`                                  |
| `DEEPSEEK_BASE_URL`                  | Endpoint URL for The Deepseek api.                                                                                                                                                                                                                                        | -                                  |
